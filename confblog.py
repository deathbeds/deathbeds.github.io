...
BLOG_TITLE = "deathbeds"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://github.com/deathbeds/deathbeds.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://github.com/deathbeds/subroutine/"
BLOG_EMAIL = "tony.fast@gmail.com"
BLOG_DESCRIPTION = "Deathbeds literate computing blog."  # (translatable)
...
POSTS = ("deathbeds/*.ipynb", "posts", "post.tmpl"),
